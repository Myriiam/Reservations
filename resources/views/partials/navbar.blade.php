      ...
      <div class="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
        <div class="flex justify-start lg:w-0 lg:flex-1">
          <a href="#">
            ...
            <img class="h-14 w-auto sm:h-24" src="{{ asset('images/logo.webp') }}" alt="">
          </a>
        </div>
            ...
            <div x-show ="menu_open" @mouseover="menu_open = true" @mouseleave="menu_open = false" class="absolute z-10 -ml-4 mt-3 transform px-2 w-screen max-w-md sm:px-0 lg:ml-0 lg:left-1/2 lg:-translate-x-1/2">
              <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                <div class="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                  ...
                  <a href="{{ route('role') }}" class="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-50">
                  ...
                  <a href="{{ route('locality_index') }}" class="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-50">
                  ...
                  <a href="{{ route('representation_index') }}" class="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-50">
