        ...
        <li class="col-span-1 flex flex-col text-center bg-white rounded-lg shadow divide-y divide-gray-200">
          <div class="flex-1 flex flex-col p-8">
            ...
            <dl class="mt-1 flex-grow flex flex-col justify-between">
              <dt class="sr-only"></dt>
              <dd class="text-gray-500 text-sm">@if($representation->location) {{ $representation->location->designation }} @else Pas de salle assignée @endif</dd>
              <dt class="sr-only"></dt>
              ...
              <dt class="sr-only"></dt>
              <dd class="text-gray-500 text-sm">{{ $representation->created_at }}</dd>
            </dl>
          </div>
          <div>
