        ...
        <div id="app4"> 
            ...
            <form action="{{ route('purchase', $show->id) }}" method="post">
                ...
                <div style="display:flex">
                    ...
                    <booking class="mx-3 bg-transparent hover:bg-red-700 text-red-700 font-semibold hover:text-white py-2 px-4 border border-red-500 hover:border-transparent rounded"></booking>
                </div>
            </form>
